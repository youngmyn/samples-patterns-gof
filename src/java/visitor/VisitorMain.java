...
import visitor.concreteElements.*;
import visitor.concreteVisitors.*;
...
/*
    ...
    пытаться вызвать visitor.visit(animal) для каждого animal из animals, то будет испльзована(если существует)
    ...
    методом accept(Visitor visitor), и в этом методе уже выполняем visitor.visit(this), и вот уже при
