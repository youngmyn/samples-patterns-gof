...
import state.concreteStates.AggressiveState;
/*
    ...
    В данном конкретном примере я сильно упростил код, что бы наглядно показать основной принцип работы.
    Я не стал реализовывать машину состояний и принципов перехода между состояниями.
...
public class StateMain {
    public static void main(String[] args) {
        ...
        john.speak();
        john.setState(new AggressiveState());
        john.speak();
    }
}
/*
