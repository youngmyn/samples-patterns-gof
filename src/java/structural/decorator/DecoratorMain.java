...
import structural.decorator.concreteDecorators.AggressivePersonDecorator;
import structural.decorator.concreteDecorators.KittenLoverPersonDecorator;
import structural.decorator.concreteDecorators.NicePersonDecorator;
import structural.decorator.concretePersons.Man;
import structural.decorator.concretePersons.Woman;
...
public class DecoratorMain {
    ...
    во избежание создания множества подклассов, а другой - для того что бы избежать обьявления множества
     ...
     Но что это такое?! Использование шаблона декоратора для создания объектов плохо,
      ...
      нет ни мяса ни овощей. Все эти промежуточные состояния не нужно выделять в отдельные обьекты
